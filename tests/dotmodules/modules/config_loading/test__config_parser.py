...
# from dotmodules.modules.modules import (
#     ConfigParser,
#     LinkCleanUpHook,
#     LinkDeploymentHook,
#     Module,
...
#         assert hook.hook_description == "path_to_script_1"

#         hook = shell_script_hooks[1]
#         assert hook.hook_name == "hook_name_2"
#         assert hook.hook_priority == 2
#         assert hook.hook_description == "path_to_script_2"
...
#         assert hook.hook_description == "Deploy 2 links"
...
#         assert hook.hook_priority == 0
#         assert hook.hook_description == "Clean up 2 links"
#         assert hook.links == module.links
...
#         assert hook.hook_name == "DEPLOY_LINKS"
#         assert hook.hook_priority == 0
#         assert hook.hook_description == "Deploy 1 link"
#         assert hook.links == module.links
...
#         assert hook.hook_name == "CLEAN_UP_LINKS"
#         assert hook.hook_priority == 0
#         assert hook.hook_description == "Clean up 1 link"
#         assert hook.links == module.links
...
#         assert hook.hook_description == "path_to_script_3"
