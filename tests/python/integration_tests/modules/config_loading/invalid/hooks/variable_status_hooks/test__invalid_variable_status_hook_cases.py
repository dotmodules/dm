...
class TestInvalidShellScriptHooksConfigParsingCases:
    ...
    def test__hooks_missing_mandatory_field_1(self, modules: Modules) -> None:
        ...
        expected = (
            "Configuration syntax error: Missing mandatory field 'variable_name' "
            "from section 'variable_status_hooks' item at index 1!"
        )
    ...
    def test__hooks_missing_mandatory_field_2(self, modules: Modules) -> None:
        ...
        with pytest.raises(ModuleError) as exception_info:
            Module.from_path(path=file_path, deployment_target="", modules=modules)
        expected = (
            "Configuration syntax error: Missing mandatory field 'path_to_script' from "
            "section 'variable_status_hooks' item at index 2!"
        )
        assert exception_info.match(expected)
    ...
    def test__hooks_additional_fields(self, modules: Modules) -> None:
        ...
        expected = (
            ...
            "'additional_field_2' found for section 'variable_status_hooks' item at index 2!"
        )
        assert exception_info.match(expected)
    ...
    def test__invalid_value_type(self, modules: Modules) -> None:
        ...
        with pytest.raises(ModuleError) as exception_info:
            Module.from_path(path=file_path, deployment_target="", modules=modules)
        expected = (
            "Configuration syntax error: The value for field 'variable_name' should "
            "be an str in section 'variable_status_hooks' item at index 1!"
        )
        assert exception_info.match(expected)
    ...
    def test__item_type_is_not_a_list_of_objects(self, modules: Modules) -> None:
        ...
        with pytest.raises(ModuleError) as exception_info:
            Module.from_path(path=file_path, deployment_target="", modules=modules)
        expected = (
            "Configuration syntax error: Invalid value for 'variable_status_hooks'! "
            "It should contain a list of objects!"
        )
        assert exception_info.match(expected)
    ...
    def test__not_a_list(self, modules: Modules) -> None:
        ...
        with pytest.raises(ModuleError) as exception_info:
            Module.from_path(path=file_path, deployment_target="", modules=modules)
        expected = (
            "Configuration syntax error: Invalid value for 'variable_status_hooks'! It should "
    ...
    def test__deployment_arget_redefines_hook(self, modules: Modules) -> None:
        ...
        expected = (
            ...
            "'variable_status_hooks__my_target' contains an already defined hook item!"
        )
        assert exception_info.match(expected)
